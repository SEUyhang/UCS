...
class QMIX:
    def __init__(self, args):
        ...
        if self.args.load_model:
            if os.path.exists(self.model_dir + '/rnn_net_params.pkl'):
                ...
                map_location = 'cuda:1' if self.args.cuda else 'cpu'
    ...
    def learn(self, mini_batch, max_episode_len, train_step, epsilon=None):  # train_step表示是第几次学习，用来控制更新target_net网络的参数
        '''
        ...
        episode_num = mini_batch['o'].shape[0]
        self.init_hidden(episode_num)
        # 对batch进行深拷贝
        batch = {key: mini_batch[key].copy() for key in mini_batch.keys()}
