...
def get_common_args():
    ...
    parser.add_argument('--n_episodes', type=int, default=8, help='the number of episodes before once training')
    parser.add_argument('--n_workers', type=int, default=8, help='total number of rollout workers')
